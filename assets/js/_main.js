...
$(document).ready(function(){
  ...
  var methods = {
    "0.23.5-install": "0",
    "0.23.5-install-(cias)": "1",
    "0.23.5-install-(csu)": "2",
    "ntrboot": "3",
    "flashing-ntrboot-(3ds-single-system)": "4",
    "flashing-ntrboot-(3ds-multi-system)": "5",
    "flashing-ntrboot-(dsi)": "6",
    "flashing-ntrboot-(nds)": "7",
    "flashing-ntrboot-(powersaves)": "8",
    "installing-boot9strap-(hardmod)": "9",
  };
  ...
  if(sidebar_shown){
    ...
    var route = {
      ...
      "7": ["ntrboot", "flashing-ntrboot-(nds)", "installing-boot9strap-(ntrboot)", "finalizing-setup"],
      "8": ["ntrboot", "flashing-ntrboot-(powersaves)", "installing-boot9strap-(ntrboot)", "finalizing-setup"],
    };
