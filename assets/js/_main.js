...
$(document).ready(function() {
  ...
  var sidebar_hidden_pages = ["404", "contribute", "credits", "dumping-titles-and-game-cartridges",
                              ...
                              "updating-b9s", "privacy-policy", "restoring-updating-cfw"];
  ...
  if(sidebar_shown){
    ...
    //
    var device_common = {
      "0": ["installing-boot9strap-(uloader)", "finalizing-setup"]
    }
